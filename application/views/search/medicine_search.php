            ...
            <div class="col-sm-12">
                <div class="column">
                    ...
                    if($this->permission1->method('manage_customer','read')->access()){ ?>
                        <a href="<?php echo base_url('Csearch/customer')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('customer_search')?></a>
                    <?php
                    }
                    ?>
			                    ...
			                    <table class="table table-bordered table-striped table-hover medicine_search">
									...
									?>
										...
										<tr>
                                            ...
                                            if($this->permission1->method('manage_medicine','read')->access()) { ?>
											<td align="center">
											   <a href="<?php echo base_url('Cproduct/product_details/{product_id}');?>" target="_blank"><button class="btn btn-success"><?php echo display('details')?></button></a>
											</td>
                                            <?php
                                            }
                                            ?>
