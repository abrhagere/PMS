			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		               	<?php echo form_open('Cproduct/product_sales_manufacturer_rate/{product_id}',array('class' => 'form-inline', ))?>
	               			<?php $today = date('d-m-Y'); $monthearlier= date('d-m-Y',strtotime('-30 days'));?>
