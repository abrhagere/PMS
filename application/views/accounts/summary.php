			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
	                	<?php echo form_open('Caccounts/summary_datewise',array('class' => 'form-inline', 'id' => 'validate'))?>
	                		<?php $today = date('Y-m-d'); ?>
							<label class="select"><?php echo display('search_by_date') ?>: <?php echo display('from') ?></label>
								<input type="text" name="from_date"  value="<?php echo $today; ?>" class="datepicker form-control" required />
		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								<tfoot>
						            <tr>
										<td colspan="3"><b><?php echo display('total_income_ammount') ?></b></td>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								<tfoot>
									<tr>
										<td colspan="3"><b><?php echo display('total_expense_ammount') ?></b></td>
