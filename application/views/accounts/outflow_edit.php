                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
					    ...
					    <div class="form-group row" id="payment_from_2">
                            ...
                            <div class="col-sm-3">
                                <input  onClick="active_customer('payment_from_2')" type="button" id="myRadioButton_2" class="btn btn-success checkbox_account" name="customer_confirm_others" value="<?php echo display('supplier') ?>"> 
                            </div>
					    </div>
