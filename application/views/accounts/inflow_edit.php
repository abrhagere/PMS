                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group row" id="payment_from_1">
                            ...
                            <div class="col-sm-3">
                                <input onClick="active_customer('payment_from_1')" type="button" id="myRadioButton_1" class="btn btn-success checkbox_account" name="customer_confirm" checked="checked" value="<?php echo display('others') ?>">
                            </div>
					    </div>
					    ...
					    <div class="form-group row" id="payment_from_2">
                            ...
                            <div class="col-sm-3">
                                <input  onClick="active_customer('payment_from_2')" type="button" id="myRadioButton_2" class="btn btn-success checkbox_account" name="customer_confirm_others" value="<?php echo display('customer') ?>"> 
                            </div>
					    </div>
					    ...
					    <div id="bank_info_hide">
						    ...
						    <div class="form-group row">
						        ...
						        <div class="col-sm-6">
                                     <input type="text" name="cheque_mature_date" data-date-format="Y-mm-dd" value="<?php echo $today; ?>" id="amount"  class="datepicker form-control"/>
						        </div>
						    </div>
