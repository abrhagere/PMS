...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small><?php echo display('invoice_wise_tax_report') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('tax') ?></a></li>
                <li class="active"><?php echo display('invoice_wise_tax_report') ?></li>
            </ol>
        </div>
    </section>
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="invoice_id" class="form-control" value="<?php echo (!empty($invoice_id)?$invoice_id:'');?>">
                        </div> 
