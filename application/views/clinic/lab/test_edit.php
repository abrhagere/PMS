            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <?php echo form_open('lab_tests/edit/'.$test->test_id, array('class' => 'form-vertical', 'id' => 'testForm')); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="test_name" id="test_name" 
                                           value="<?php echo set_value('test_name', $test->test_name); ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="test_code" id="test_code" 
                                           value="<?php echo set_value('test_code', $test->test_code); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="test_category" id="test_category" 
                                           value="<?php echo set_value('test_category', $test->test_category); ?>" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" name="description" id="description" rows="3"><?php echo set_value('description', $test->description); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="normal_range" id="normal_range" 
                                           value="<?php echo set_value('normal_range', $test->normal_range); ?>" 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" class="form-control" name="price" id="price" 
                                           value="<?php echo set_value('price', $test->price); ?>" step="0.01" min="0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="1" <?php echo ($test->status == 1) ? 'checked' : ''; ?>> Active
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="status" value="0" <?php echo ($test->status == 0) ? 'checked' : ''; ?>> Inactive
                                    </label>
                                </div>
                            </div>
