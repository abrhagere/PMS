            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <?php echo form_dropdown('designation',$desig,null,'class="form-control" style="width:100%"') ?>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input name="hrate" class="form-control" type="text" placeholder="<?php echo display('hour_rate_or_salary') ?>" id="hrate">
                        </div>
