...
<div class="content-wrapper">
	...
	<section class="content">
        ...
        <?php
        if($this->permission1->method('office_manage_loan','read')->access() || $this->permission1->method('office_manage_loan','update')->access()){ ?>
        <!-- Account List -->
		<div class="row">
		    <div class="col-sm-12">
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
			           			<thead>
									<tr>
                                        ...
                                        <?php
                                        if($this->permission1->method('office_manage_loan','update')->access()){ ?>
									...
									{person_list}
										<tr>
                                            ...
                                            <td>
												<center>
													<a href="
											<?php echo base_url('Csettings/person_ledger/{person_id}');?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
