            ...
            <div class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                   <?php echo form_dropdown('employee_id',$employee,(!empty($data->employee_id)?$data->employee_id:null),'class="form-control" id="employee_id"  onchange="employechange(this.value)"') ?>
                 </div>
               </div>
