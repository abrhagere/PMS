            ...
            <div class="col-sm-12 col-md-4 ">
                ...
                <div class="login-widget">
                    <div class="panel panel-bd">
                        ...
                        <?php echo form_open_multipart('Admin_dashboard/change_password',array('id' => 'validate','class' => 'form-horizontal'))?>
                            <div class="panel-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" placeholder="<?php echo display('email') ?>" class="form-control" id="email" name="email" required />  
                                </div>
                                <label for="login-email"><?php echo display('old_password') ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                    <input type="password" placeholder="<?php echo display('old_password') ?>" class="form-control" id="old_password" name="old_password" required />
                                </div>
                                <h4 class="text-center"><?php echo display('new_information') ?></h4>
                                <label for="login-email"><?php echo display('new_password') ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                    <input type="password" placeholder="<?php echo display('new_password') ?>" class="form-control" id="password" name="password" required />
                                </div>
                                <label for="login-email"><?php echo display('re_type_password') ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                    <input type="password" placeholder="<?php echo display('re_type_password') ?>" class="form-control" id="repassword" name="repassword" required  />
                                </div>
                            </div>
