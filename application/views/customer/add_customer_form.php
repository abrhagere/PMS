                  ...
                  <?php echo form_open('Ccustomer/insert_customer', array('class' => 'form-vertical','id' => 'insert_customer'))?>
                    <div class="panel-body">
                        <div class="form-group row">
                            <label for="stock_name" class="col-sm-3 col-form-label"><?php echo display('stock') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label for="tin_number" class="col-sm-3 col-form-label"><?php echo display('tin') ?> </label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="tin_number" id="tin_number" type="text" placeholder="<?php echo display('tin') ?>"   tabindex="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="vat_number" class="col-sm-3 col-form-label"><?php echo display('vatt') ?> <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input class="form-control" name ="vat_number" id="vat_number" type="text" placeholder="<?php echo display('vatt') ?>"   tabindex="1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="house_number" class="col-sm-3 col-form-label"><?php echo display('ho') ?></label>
                            <div class="col-sm-6">
                               <input class="form-control" name ="house_number" id="house_number" type="text" placeholder="<?php echo display('ho') ?>" min="0" tabindex="3">
                            </div>
                        </div>
