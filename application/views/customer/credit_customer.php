...
$(document).ready(function() { 
 ...
 "footerCallback": function (row, data, start, end, display) {
    ...
    // Define the class names of columns you want to total
    var columnsToSum = ['balance', 'invoice_balance', 'prev'];

    // Loop through each column class and calculate totals
    columnsToSum.forEach(function (columnClass) {
        api.columns('.' + columnClass, { page: 'current' }).every(function () {
            var sum = this
                .data()
                .reduce(function (a, b) {
            ...
            // Update footer cell with formatted total
            $(this.footer()).html(
