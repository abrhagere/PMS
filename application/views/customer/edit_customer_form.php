                  ...
                  <?php echo form_open_multipart('Ccustomer/customer_update',array('class' => 'form-vertical', 'id' => 'customer_update'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="tin_number" id="tin_number" type="text" placeholder="<?php echo display('tin') ?>"  required="" value="{tin_number}" tabindex="1">
                                 <input type="hidden" value="{tin_number}" name="oldtin">
                            </div>
                        </div>
