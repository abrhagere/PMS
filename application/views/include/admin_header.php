             ...
             <li class="treeview <?php if ($this->uri->segment('1') == ("Cpurchase")) { echo "active";}else{ echo " ";}?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <!-- detail purchese-->
                     <?php
                    if($this->permission1->method('manage_purchase','read')->access() || $this->permission1->method('manage_purchase','update')->access() || $this->permission1->method('manage_purchase','delete')->access()){ ?>
                        <li  class="treeview <?php  if ($this->uri->segment('2') == ("detail_purchase")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Cpurchase/detail_purchase')?>"><?php echo display('detail_pur') ?></a></li>
                    <?php
                     }
                    ?>
...
<?php } ?>
           ...
           ?>
            ...
            <!-- Report menu start -->
             <?php
            if($this->permission1->module('todays_report')->access() || $this->permission1->module('expense_report')->access() || $this->permission1->module('sales_report')->access() || $this->permission1->module('purchase_report')->access() || $this->permission1->module('sales_report_medicine_wise')->access() || $this->permission1->module('profit_loss')->access() || $this->permission1->module('grand_paid_profit')->access()){ ?>
                <!-- Report menu start -->
            <li class="treeview <?php if ($this->uri->segment('2') == ("all_report") || $this->uri->segment('2') == ("todays_sales_report") || $this->uri->segment('2') == ("todays_purchase_report") || $this->uri->segment('2') == ("product_sales_reports_date_wise") || $this->uri->segment('2') == ("total_profit_report") || $this->uri->segment('2') == ("profit_manufacturer_form") || $this->uri->segment('2') == ("profit_productwise_form") || $this->uri->segment('2') == ("profit_productwise") || $this->uri->segment('2') == ("profit_manufacturer") ) { echo "active";}else{ echo " ";}?>">
                ...
                <ul class="treeview-menu">
                    ...
                    if($this->permission1->method('sales_report_medicine_wise','read')->access()){ ?>
                     ...
                     <!-- expense-->
                       <?php
                    if($this->permission1->method('expense_report','read')->access()){ ?>
                      <li class="treeview <?php  if ($this->uri->segment('2') == ("expense_report")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Admin_dashboard/expense_report')?>"><?php echo display('expense_report') ?></a></li>
                    <?php } ?>
                    <!-- grand/net profit-->
                     
                       <?php
                    if($this->permission1->method('grand_profit','read')->access()){ ?>
                      <li class="treeview <?php  if ($this->uri->segment('2') == ("grand_profit")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>"><a href="<?php echo base_url('Admin_dashboard/grand_profit')?>"><?php echo display('grand_paid_profit') ?></a></li>
                    <?php } ?>
...
<?php
     ...
     <?php } ?>
        ...
        <?php } ?>
               <!-- =============================== Payroll menu end =================== -->
                <!-- =======================   Expense menu start ========================= -->
         <?php if($this->permission1->method('add_expense_item','create')->access() || $this->permission1->method('manage_expense_item','read')->access() || $this->permission1->method('add_expense','create')->access() || $this->permission1->method('manage_expense','read')->access() | $this->permission1->method('expense_statement','read')->access()){?>
             <li class="treeview <?php
