            ...
            <div class="col-sm-3">
                <div class="panel panel-bd">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td align="center"><?= $manufacturer_info[0]['manufacturer_name'];?><br>
                                                        <?php if ($manufacturer_info[0]['address']) { ?>
                                                            <?= $manufacturer_info[0]['address'];?><br>
                                                        <?php } ?>
                                                        <?php if ($manufacturer_info[0]['mobile']) { ?>
                                                           <?= $manufacturer_info[0]['mobile'];?>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="panel-footer text-left">
                        <a  class="btn btn-danger" href="<?php echo base_url('accounts/manufacturer_payment'); ?>"><?php echo display('cancel') ?></a>
