...
<div id="printArea">
            <table width="99%" align="center" style="margin:5px 5px;" cellpadding="5" cellspacing="5" border="2"> 
                ...
                <tr align="center">
                    ...
                    <td colspan="7"><font size="+1" style="font-family:'Arial'"> <strong><?php echo display('general_ledger_of').' '.$ledger[0]['HeadName'].' on '.$dtpFromDate. ' To '  .$dtpToDate;?></strong></font><strong></th></strong>
                </tr>
