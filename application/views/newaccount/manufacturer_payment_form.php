    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?= form_open_multipart('accounts/create_manufacturer_payment') ?>
       ...
       <select name="manufacturer_id" id="manufacturer_id_1" class="form-control" onchange="load_code(this.value,1)" required>
        <<option value="">Select manufacturer</option>}
        option
         <?php foreach ($manufacturer_list as $suplier) {?>
   <option value="<?php echo $suplier->manufacturer_id;?>"><?php echo $suplier->manufacturer_name;?></option>
         <?php }?>
       </select>
...
<script type="text/javascript">
  ...
  function load_code(id,sl){
    ...
    $.ajax({
        url : "<?php echo site_url('accounts/manufacturer_headcode/')?>" + id,
        type: "GET",
        dataType: "json",
