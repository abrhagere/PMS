            ...
            <div id="printArea">
                <div class="panel-body">
                  <table width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                      <td width="85%" bgcolor="#B0E0E6" align="center" style="font-size:18px; border-left:solid 1px #000; border-top:solid 1px #000;"><?php echo display('particulars')?></td>
                      <td width="15%" bgcolor="#B0E0E6" align="center" style="font-size:18px; border-left:solid 1px #000; border-right:solid 1px #000;border-top:solid 1px #000;"><?php echo display('amount')?></td>
                    </tr>
                    <?php
