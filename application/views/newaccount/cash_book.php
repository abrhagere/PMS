            ...
            <div class="panel-body"  id="printArea">
                ...
                <div>
                    ...
                    <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                       <caption class="text-center"><font size="+1" style="font-family:'Arial'"> <strong> <?php echo display('cash_book_report')?>  (<?php echo display('from')?> <?php echo $FromDate; ?> <?php echo display('to')?> <?php echo $ToDate;?>)</font><strong></caption>
                        <tr class="table_data">
                            <td width="3%" >&nbsp;</td>
                            <td width="10%">&nbsp;</td>
                            <td width="14%">&nbsp;</td>
