...
<div class="content-wrapper">
    ...
    <section class="content">
     <?php
        if($this->permission1->method('manage_company','update')->access()){ ?>
        <!-- Edit Company -->
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Company_setup/company_update',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <!-- tin number-->
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label"><?php echo display('tin') ?> </label>
                            <div class="col-sm-6">
                                <input type="text" tabindex="2" class="form-control" name="tin_number" value="{tin_number}"  placeholder="<?php echo display('tin_number') ?>"  />
                            </div>
