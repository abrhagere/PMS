<h2><?php echo display('new_deposit')?></h2>
<div class="form-container">
    <form class="form-vertical" action="<?=base_url()?>cdeposit/insert_deposit" id="insert_deposit" method="post"  name="insert_deposit" enctype="multypart/formdata">
				...
				<tbody id="form-actions">
					<tr class="">
						<td colspan="3" class="span2">
							<input type="number" class="span2 text-right" name="amount" placeholder="<?php echo display('amount')?>" required />
						</td>
						<td colspan="3">
						&nbsp;
						</td>
        ...
        <div class="form-actions">
           <input type="submit" id="add-deposit" class="btn btn-primary btn-large" name="add-deposit" value="<?php echo display('save')?>" />
            <input type="submit" value="<?php echo display('save_and_add_another_one')?>" name="add-deposit-another" class="btn btn-large" id="add-deposit-another">
        </div>
    </form>
</div>
