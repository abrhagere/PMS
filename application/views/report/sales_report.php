                                    ...
                                    <table class="table table-bordered table-striped table-hover" id="SalesReportTable">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td id="total_sales" style="text-align: right;"></td>
                                                <td id="total_paid" style="text-align: right;"></td>
                                                <td id="total_due" style="text-align: right;"></td>
                                                <td id="total_manufacturer" style="text-align: right;"></td>
                                                <td id="total_grand_profit" style="text-align: right;"></td>
                                                <td id="total_paid_profit" style="text-align: right;"></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
$(document).ready(function() {
    ...
    if ($('#SalesReportTable tbody tr').length > 0) {
