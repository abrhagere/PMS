...
<div class="content-wrapper">
    ...
    <tfoot>
        <tr>
            <td colspan="3" style="text-align: right; font-size: 14px !important;">
                <b><?php echo display('total_purchase') ?></b>
            </td>
            <td style="text-align: right; font-weight: bold;" id="totalPurchaseAmount"></td>
        </tr>
    </tfoot>
</table>
    ...
    var table = $('#purchaseReportTable').DataTable({
        ...
        footerCallback: function(row, data, start, end, display) {
            ...
            var total = api
                ...
                .data()
                .reduce(function(a, b) {
                    // b is like "৳ 123.45" or "123.45 ৳"
                    if (typeof b === 'string') {
                        // Remove all characters except digits, minus sign, dot
                        b = b.replace(/[^0-9.\-]+/g,"");
                    }
