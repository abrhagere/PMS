                                    ...
                                    <tr>
                                        <td class="span3 manufacturer">
                                           ...
                                           <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list({sl});" placeholder="<?php echo display('product_name') ?>" id="product_name_{sl}" tabindex="5" value="{product_name}"  >
                                            ...
                                            <input type="hidden" name="invoice_id" class="il" value="{invoice_id}">
                                         ...
                                         <td>
                                            ...
                                            <td class="test">
                                                <input type="text" name="product_rate[]" onkeyup="calculate_store({sl}),checkqty({sl});" onchange="calculate_store({sl});" id="product_rate_{sl}" class="form-control product_rate_{sl} text-right" placeholder="0.00" value="{rate}" required="required" min="0" tabindex="7" />
                                            </td>
                                             <td class="test1">
                                             <input type="text" name="sale_rate[]" id="sell_rate_{s1}" class="form-control sell_rate_{s1} text-right" placeholder="0.00" value="{sell_price}" min="0" tabindex="9" required="required" />
                                            </td>
  ...
  // Counts and limit for purchase order
    ...
    function addPurchaseOrderField1(divName){
        if (count == limits)  {
           ...
           newdiv.innerHTML =
'<td class="span3 manufacturer">'+
    '<input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list('+ count +');" placeholder="<?php echo display("product_name") ?>" id="product_name_'+ count +'" tabindex="'+tab1+'" > '+
...
'</td>'+
'<td>'+
    '<input type="text" name="batch_id[]" id="batch_id_'+ count +'" class="form-control text-right" required placeholder="<?php echo display('batch_id') ?>"/>'+
'</td>'+
'<td>'+
    '<input type="text" name="expeire_date[]" onchange="checkExpiredate('+ count +')" id="expeire_date_'+ count +'" required class="form-control datepicker" placeholder="<?php echo display('expeire_date') ?>"/>'+
'</td>'+
'<td class="wt">'+
    '<input type="text" id="available_quantity_'+ count +'" class="form-control text-right stock_ctn_'+ count +'" placeholder="0.00" readonly/>'+
'</td>'+
'<td class="text-right">'+
    '<input type="text" name="product_quantity[]" tabindex="'+tab2+'" required id="quantity_'+ count +'" class="form-control text-right store_cal_'+ count +'" onkeyup="calculate_store('+ count +'),checkqty('+ count +');" onchange="calculate_store('+ count +');" placeholder="0.00" value="" min="0"/>'+
'</td>'+
'<td class="test">'+
    '<input type="text" name="product_rate[]" required onkeyup="calculate_store('+ count +'),checkqty('+ count +');" onchange="calculate_store('+ count +');" id="product_rate_'+ count +'" class="form-control product_rate_'+ count +' text-right" readonly placeholder="0.00" value="" min="0" tabindex="'+tab3+'"/>'+
'</td>'+
'<td class="test1">'+
    '<input type="text" name="sale_rate[]" id="sell_rate_'+ count +'" class="form-control sell_rate_'+ count +' text-right" placeholder="0.00" value="" min="0" tabindex="'+tab4+'" required="required"/>'+
'</td>'+
'<td class="text-right">'+
...
'<td>'+
    ...
    '<button style="text-align: right;" class="btn btn-danger red" type="button" value="<?php echo display('delete')?>" onclick="deleteRow(this)" tabindex="'+tab5+'"><?php echo display('delete')?></button>'+
'</td>';
