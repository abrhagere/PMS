                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="130"><?php echo display('total') ?>
                                        </th>
   ...
   <td>
    ...
    <td>
        <select class="form-control" id="invoice_id_<?php echo $sl ?>" name="inv_id[]" onchange="invoice_stock(<?php echo $sl ?>)" required>
            <option value="<?php echo $invoice['pinvoice_id']; ?>"><?php echo $invoice['pinvoice_id']; ?></option>
        </select>
    </td>

    <!-- Available Quantity -->
    <td>
        <input type="text" name="available_quantity[]" class="form-control text-right available_quantity_<?php echo $sl ?>" value="0" readonly id="available_quantity_<?php echo $sl ?>"/>
    </td>
